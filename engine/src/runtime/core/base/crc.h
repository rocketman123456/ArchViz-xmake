...
namespace ArchViz
{
    ...
    public:
        ...
        uint8_t calculate(const uint8_t* data_in, const std::size_t length);
    ...
    public:
        ...
        uint16_t calculate(const uint8_t* data_in, const std::size_t length);
        void     printLookupTable();
    ...
    public:
        ...
        uint32_t calculate(const uint8_t* data_in, const std::size_t length);
        void     printLookupTable();
