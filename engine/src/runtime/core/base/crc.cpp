...
namespace ArchViz
{
    ...
    uint8_t CRC8::calculate(const uint8_t* data, const std::size_t length)
    {
    ...
    uint16_t CRC16::calculate(const uint8_t* data, const std::size_t length)
    {
    ...
    uint32_t CRC32::calculate(const uint8_t* data, const std::size_t length)
    {
